...
This theme provides also classical features like Google Analytics, Twitter, Disqus and Pygments integration.title: (.*)
date: 2021-03-31
...
![screenshot2](screenshot2.png)title: (.*)
date: 2021-03-31
...
* ``PELICAN_SOBER_TWITTER_CARD_SITE = '__company__' `` (website/company twitter account)title: (.*)
date: 2021-03-31
