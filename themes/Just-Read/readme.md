...
"Just Read" is a theme for [Pelican](http://alexis.notmyidea.org/pelican/). The fluid-width layout is based based on the Golden Grid System by [Joni Korpi](http://jonikorpi.com/).title: (.*)
date: 2021-03-31
...
*Note: I tested the theme only in the latests version of Chrome, Firefox, Opera and Safari. *title: (.*)
date: 2021-03-31
